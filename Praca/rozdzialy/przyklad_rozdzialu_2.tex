...
\centering
    \begin{tabular}{|l|l|c|}
    \hline
    \multicolumn{1}{|l|}{\textbf{Lp.}} & \multicolumn{1}{l|}{\textbf{Parametr}} & \multicolumn{1}{c|}{\textbf{Warto¶æ}} \\
    \hline
       1.   & Napiêcie zasilania [V] & 12  \\
    \hline
       2.   &  Prêdko¶æ obrotowa [obr/min]& 200\\
    \hline
    ...
    \hline
       7.  & Rozdzielczo¶æ enkodera [imp/obr]   &  75 \\
    \hline
    \end{tabular}
  \label{silnik_skret}
\end{table}
